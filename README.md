...
<p> *Rancher v2.8.2: We have identified an issue with Rancher v2.8.2 where variables related to ACI CNI 6032 are not being picked up by Rancher UI during cluster configuration updates or initial cluster creation.</p>
<p> **Rancher v2.8.3: We have observed only aci 6041 variables are not picked up rancher during cluster configuration updated or initial cluster creation, However other ACI CNI till 6033 are being picked by Rancher v2.8.3.</p>
